...
(function($){
    $(document).ready(function() {
        var mob_trigger = function() {
            var scrollheight = $(document).height();
            $('body').removeClass('bodyhidden');
            $('.nav-primary').height(scrollheight);
            $(this).parent().toggleClass('is_mobile_active');
            $(this).parent().siblings().removeClass('is_mobile_active');
        ...
        enquire
            ...
            .register("screen and (max-width:1023)", function() {
                // Mage functions    
                $('.cat-left-col').css('display' , 'none');
                $('.sort-btn a').removeClass('active');
            }) 
            .register("screen and (min-width:1024)", function() {
                // Mage functions    
            ...
            .register("screen and (min-width:1140px)", function() {
                $('body').removeClass('bodyhidden');
                $(".menu-toggle").removeClass('is_mobile_menu_open');
                $(".nav-primary").removeClass('is_nav_open');
                ...
                $('.nav-primary-item-link').hover(function() {
                    if ($(this).parent().hasClass('has-subnav')) {
                        ...
                        $('.site-header').addClass('nav_hovered');
                        $('.nav-primary').addClass('is_hover');
                        $('.nav-primary-item').removeClass('active');
                ...
                $('.submenu').hover(function() {
                    $(this).parent().addClass('subnav_is_hover');
                }, function() {
                    $('.has-subnav').removeClass('active');
                    $('.nav-overlay').removeClass('is_open');
                    $('.nav-primary').removeClass('is_hover');
                    $('.site-header').removeClass('nav_hovered');
                    $('.nav-primary-item').removeClass('subnav_is_hover');
                });
        ...
        $('.apply-promo .item1').click(function() {
            $(this).toggleClass('active');
            $('.apply-promo-content').slideToggle();
            return false
        }); 
        $('.estimate-shipping .item1').click(function() {
            $(this).toggleClass('active');
            $('.shipping-outside').toggleClass('active');
            $('.estimate-shipping-content').slideToggle();
            return false
        });

        $('.promo-popup').click(function() {
            $('#shippingoutside').fadeIn();
            return false
        }); 
        ...
        detachPoint = 400, // point of detach (after scroll passed it, menu is fixed)
